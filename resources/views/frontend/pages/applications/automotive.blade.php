        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row overview-sec">
                        <div class="col-lg-6">
                            ...
                            <p class="mb-4">At DoradoImpex, our advanced 3D printing solutions turn digital concepts
                                into precise,
                                physical components with unmatched speed and accuracy. This technology accelerates
                                research, shortens production timelines, reduces costs, and streamlines every stage of
                                the supply chain.</p>
                       ...
                       <div class="col-lg-6 ps-lg-5 mt-4 mt-lg-0">
                            <ul class="ps-5">
                                <li>High-speed prototyping</li>
                                <li>Innovative product development</li>
                                <li>Streamlined production cycles</li>
                                <li>Optimized supply chain</li>
                                <li>Enhanced quality assurance</li>
                                <li>Performance-driven product refinement</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="desc-1">
                        ...
                        <p class="my-4">With advanced 3D printing technology, we enable fast and precise prototyping of
                            automotive
                            components, reducing lead times and supporting iterative design improvements. Our dedicated
                            R&D team ensures each prototype undergoes rigorous testing, driving innovation while
                            maintaining exceptional product reliability and performance.</p>
                        <ul>
                            <li>Accelerate design-to-prototype timelines</li>
                            <li>Conduct rapid testing and performance validation</li>
                            <li>Improve automotive efficiency, safety, and durability</li>
                            <li>Foster innovation for next-generation vehicle solutions</li>
                        </ul>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/automotive-1.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/automotive-2.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/automotive-3.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/automotive-4.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="desc-2-with-cards pt-5">
                        ...
                        <p class="my-4">DoradoImpex 3D printing technologies help lower development costs by minimizing
                            material waste, simplifying production workflows, and enabling faster design iterations.
                            This results in significant savings and greater efficiency across your entire product
                            lifecycle.</p>
                            ...
                            <div class="row gy-5">
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            <h4>Tailored Product Design</h4>
                                            <p>We enable fully customized designs that meet precise market demands. Our
                                                flexible workflows let you adjust and refine quickly to maintain a
                                                competitive edge.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            <h4>Complex Geometry Production</h4>
                                            <p>Our printers produce lightweight, intricate parts that improve
                                                performance and efficiency, unlocking design freedom and inspiring
                                                innovation.
                                ...
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            ...
                                            <p>Reduce storage costs with just-in-time production. We align manufacturing
                                                volumes to real-time market needs, cutting excess inventory expenses.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            <h4>Smarter Supply Chains</h4>
                                            <p>Print spare parts when needed, simplify logistics, and enhance
                                                maintenance workflows. DoradoImpex technology keeps your supply chain
                                                lean and responsive</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="desc-3 mt-5 pt-5">
                        ...
                        <p>DoradoImpex is dedicated to creating eco-conscious 3D printing materials and implementing
                            sustainable manufacturing processes. By reducing waste, optimizing energy use, and
                            innovating greener solutions, we help shape a cleaner and more sustainable future for the
                            industry.</p>
                        ...
                        <div class="tow-img-sec-2">
                            <div class="row py-4">
                                <div class="col-lg-6 pe-lg-5 mb-4 mb-lg-0">
                                    <div class="img-wrapper">
                                        <img src="{{ Vite::asset('resources/assets/images/image_7.jpg') }}" alt=" automotive img" class="img-fluid">
                                    </div>
                                </div>
                                <div class="col-lg-6 ps-lg-5">
                                    <div class="img-wrapper">
                                        <img src="{{ Vite::asset('resources/assets/images/image_8.jpg') }}" alt=" automotive img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 ps-lg-5">
                    <div class="app-right-sec overflow-hidden">
                        <!-- HEADING START  -->
                        ...
                        <div class="app-pages-link-wrapper">
                            <ul class="list-unstyled">
                                <li class="active"><a href="/applications/automotive">Automotive</a></li>
