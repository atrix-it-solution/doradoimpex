...
@section('title','Additive-Manufacturing')
                ...
                <div class="col-lg-8">
                    <div class="row overview-sec">
                        <div class="col-lg-6">
                            ...
                            <p class="mb-4">Additive manufacturing, commonly known as 3D printing, revolutionizes production by enabling the creation of complex, high-precision components directly from digital models. DoradoImpex’s advanced additive manufacturing solutions empower industries to produce parts faster, reduce waste, and unlock new design possibilities. From prototyping to end-use products, our technology streamlines workflows and enhances innovation potential across sectors.</p>
                            <a href="/contact" class="button-3 py-3">Get Consultation <i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                       <div class="col-lg-6 ps-lg-5 mt-4 mt-lg-0">
                            <ul class="ps-5">
                                <li>Create intricate geometries not possible with traditional manufacturing</li>
                                <li>Accelerate prototyping and production timelines</li>
                                <li>Reduce material waste through precise layer-by-layer fabrication</li>
                                <li>Enable on-demand and decentralized manufacturing</li>
                                <li>Support a wide range of materials for various applications</li>
                                <li>Lower tooling and setup costs for low- and high-volume runs</li>
                            </ul>
                        </div>
                    </div>
                    <div class="row two-img-sec sec-padding sec-margin ">
                        <div class="col-lg-6 ps-lg-0 mb-4 mb-lg-0">
                            <div class="img-wrapper">
                                <img src="{{ Vite::asset('resources/assets/images/Aimage_1.jpg') }}" alt="" class="img-fluid rounded-2">
                            </div>
                        </div>
                        <div class="col-lg-6 pe-lg-0">
                            <div class="img-wrapper">
                                <img src="{{ Vite::asset('resources/assets/images/Aimage_2.jpg') }}" alt="" class="img-fluid rounded-2">
                            </div>
                        </div>
                    </div>
                    <div class="desc-1">
                        <h2>Rapid Prototyping</h2>
                        <p class="my-4">Additive manufacturing significantly speeds up the prototyping process by allowing designers and engineers to create, test, and refine parts within hours. DoradoImpex’s solutions ensure exceptional detail, accuracy, and repeatability—reducing development cycles and enabling more efficient design iteration.</p>
                        <ul>
                            <li>Produce functional prototypes quickly and accurately</li>
                            <li>Reduce design-to-production timelines</li>
                            <li>Support multiple iterations without costly retooling</li>
                            <li>Improve collaboration between design and engineering teams</li>
                        </ul>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/Aimage_3.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/Aimage_4.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/Aimage_5.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/Aimage_6.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="desc-2-with-cards pt-5">
                        ...
                        <p class="my-4">By removing the need for expensive tooling, molds, and excess materials, additive manufacturing drastically lowers production costs. DoradoImpex helps businesses minimize waste, reduce outsourcing, and achieve more efficient in-house production, making high-quality parts more affordable than ever.</p>
                            ...
                            <div class="row gy-5">
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            <h4>Tool-Free Production</h4>
                                            <p>Eliminate costly molds and tooling by printing directly from CAD designs.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            <h4>Complex, Cost-Effective Designs</h4>
                                            <p>Create intricate parts in a single print, reducing assembly costs and complexity.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            ...
                                            <p>Produce parts only when needed, lowering inventory and storage costs.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            ...
                                            <p>Minimize material consumption by using only what’s required for the part.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="desc-3 mt-5 pt-5">
                        ...
                        <p>Additive manufacturing supports sustainable production by minimizing waste, enabling localized manufacturing, and reducing energy consumption compared to traditional processes. DoradoImpex is committed to advancing eco-conscious manufacturing solutions that balance performance with environmental responsibility.</p>

                        <div class="tow-img-sec-2">
                            <div class="row py-4">
                                <div class="col-lg-6 pe-lg-5 mb-4 mb-lg-0">
                                    <div class="img-wrapper">
                                        <img src="{{ Vite::asset('resources/assets/images/Aimage_7.jpg') }}" alt=" automotive img" class="img-fluid">
                                    </div>
                                </div>
                                <div class="col-lg-6 ps-lg-5">
                                    <div class="img-wrapper">
                                        <img src="{{ Vite::asset('resources/assets/images/Aimage_8.jpg') }}" alt=" automotive img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="app-right-sec">
                        ...
                        <div class="app-pages-link-wrapper">
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="/applications/additive-manufacturing">Additive Manufacturing</a></li>
