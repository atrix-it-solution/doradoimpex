...
@section('title','Jewelry-Industry')
                ...
                <div class="col-lg-8">
                    <div class="row overview-sec">
                        <div class="col-lg-6">
                            ...
                            <p class="mb-4">In the jewelry industry, craftsmanship meets innovation through 3D printing. DoradoImpex’s advanced additive manufacturing allows jewelers to create intricate, one-of-a-kind pieces with unmatched precision and design freedom. From custom engagement rings to luxury watch components, our technology shortens production timelines, reduces waste, and enables bold creative expression.</p>
                            <a href="/contact" class="button-3 py-3">Get Consultation <i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                       <div class="col-lg-6 ps-lg-5 mt-4 mt-lg-0">
                            <ul class="ps-5">
                                <li>Produce intricate, high-precision jewelry designs</li>
                                <li>Enable rapid creation of custom, one-of-a-kind pieces</li>
                                <li>Eliminate traditional mold-making time and cost</li>
                                <li>Reduce material waste through precision printing</li>
                                <li>Accelerate concept-to-market timelines</li>
                                <li>Support innovative, complex geometries in precious metals</li>
                            </ul>
                        </div>
                    </div>
                    <div class="row two-img-sec sec-padding sec-margin ">
                        <div class="col-lg-6 ps-lg-0 mb-4 mb-lg-0">
                            <div class="img-wrapper">
                                <img src="{{ Vite::asset('resources/assets/images/Jimage_1.jpg') }}" alt="" class="img-fluid rounded-2">
                            </div>
                        </div>
                        <div class="col-lg-6 pe-lg-0">
                            <div class="img-wrapper">
                                <img src="{{ Vite::asset('resources/assets/images/Jimage_2.jpg') }}" alt="" class="img-fluid rounded-2">
                            </div>
                        </div>
                    </div>
                    <div class="desc-1">
                        <h2>Rapid Prototyping</h2>
                        <p class="my-4">DoradoImpex’s 3D printing solutions transform jewelry prototyping, allowing designers to test shapes, details, and comfort with speed and accuracy. This empowers jewelers to refine their designs before production, reducing costly errors and enabling faster client approvals..</p>
                        <ul>
                            <li>Quickly produce detailed prototype models</li>
                            <li>Test fit, comfort, and visual appeal before final casting</li>
                            <li>Reduce rework by identifying design improvements early</li>
                            <li>Accelerate client decision-making with tangible samples</li>
                        </ul>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/Jimage_3.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/Jimage_4.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/Jimage_5.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="img-wraper">
                                    <img src="{{ Vite::asset('resources/assets/images/Jimage_6.jpg') }}" alt="automotive img" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="desc-2-with-cards pt-5">
                        ...
                        <p class="my-4">By integrating additive manufacturing, jewelry makers can lower production costs through reduced material waste, elimination of multiple mold iterations, and the ability to produce designs in-house. DoradoImpex’s solutions help artisans and manufacturers achieve high-quality results at a fraction of the traditional cost.</p>
                                ...
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            ...
                                            <p>Minimize precious metal waste with exacting 3D printing precision, lowering material expenses.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            <h4>Complex Design Capability</h4>
                                            <p>Create elaborate, lightweight structures that are impossible with conventional techniques.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            ...
                                            <p>Manufacture custom pieces on demand without relying on external mold-making or casting services.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-wrapper">
                                        ...
                                        <div class="card-desc">
                                            ...
                                            <p>Shorten production timelines and reduce labor costs with efficient digital workflows.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="desc-3 mt-5 pt-5">
                        ...
                        <p>3D printing in the jewelry industry promotes sustainability by reducing waste of precious metals, enabling local production, and eliminating excess material from traditional casting processes. DoradoImpex supports jewelers in adopting greener, more efficient manufacturing methods.</p>

                        <div class="tow-img-sec-2">
                            <div class="row py-4">
                                <div class="col-lg-6 pe-lg-5 mb-4 mb-lg-0">
                                    <div class="img-wrapper">
                                        <img src="{{ Vite::asset('resources/assets/images/Jimage_7.jpg') }}" alt=" automotive img" class="img-fluid">
                                    </div>
                                </div>
                                <div class="col-lg-6 ps-lg-5">
                                    <div class="img-wrapper">
                                        <img src="{{ Vite::asset('resources/assets/images/Jimage_8.jpg') }}" alt=" automotive img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="app-right-sec">
                        ...
                        <div class="app-pages-link-wrapper">
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="/applications/jewelry-industry">Jewelry Industry</a></li>
